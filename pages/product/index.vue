<template>
    <div class="m-14 bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full">
                    ...
                    <div class="w-full mb-6 overflow-x-auto">
                      <form action="">
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns"><div class="dataTable-top"><div class="dataTable-dropdown"><label><select class="dataTable-selector"><option value="5">5</option><option value="10" selected="">10</option><option value="15">15</option><option value="20">20</option><option value="25">25</option></select> entries per page</label></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"></div></div><div class="dataTable-container"><table class="table-sorter table-bordered w-full ltr:text-left rtl:text-right text-gray-600 dark:text-gray-400 dataTable-table">
                          <thead>
                            <tr class="bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40"><th data-sortable="false" style="width: 8.93246%;"><input id="check_all" type="checkbox" class="form-checkbox w-4 h-4 text-indigo-500 border border-gray-300 rounded dark:bg-gray-700 dark:border-gray-700"></th><th data-sortable="" style="width: 53.5948%;"><a href="#" class="dataTable-sorter">Products</a></th><th class="hidden lg:table-cell" data-sortable="" style="width: 0%;"><a href="#" class="dataTable-sorter">Update</a></th><th data-sortable="" style="width: 19.8257%;"><a href="#" class="dataTable-sorter">Pricing</a></th><th class="hidden lg:table-cell" data-sortable="" style="width: 0%;"><a href="#" class="dataTable-sorter">Qty</a></th><th class="hidden lg:table-cell" data-sortable="" style="width: 0%;"><a href="#" class="dataTable-sorter">Status</a></th><th data-sortable="false" style="width: 17.6471%;">Actions</th></tr>
                          </thead>
