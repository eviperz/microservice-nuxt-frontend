        ...
        <section class="flex mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 gap-10 justify-center items-center">
            ...
            <div id="selected" class="m-4 w-24">
                <div v-for="image in product.images" :key="image.src">
                    <img class="m-5" src="{{ image.src }}" alt="">
                </div>

                <img class="m-5" src="https://image.uniqlo.com/UQ/ST3/th/imagesgoods/424873/item/thgoods_10_424873.jpg?width=750" alt="">
                <img class="m-5" src="https://image.uniqlo.com/UQ/ST3/th/imagesgoods/424873/item/thgoods_10_424873.jpg?width=750" alt="">
                <img class="m-5" src="https://image.uniqlo.com/UQ/ST3/th/imagesgoods/424873/item/thgoods_10_424873.jpg?width=750" alt="">
                <img class="m-5" src="https://image.uniqlo.com/UQ/ST3/th/imagesgoods/454315/item/thgoods_00_454315.jpg?width=750" alt="">
            </div>
